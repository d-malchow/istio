...
const TemplateName = "listipentry"

// Instance is constructed by Mixer for the 'listipentry' template.
//
...
// process data associated with the 'listipentry' template.
//
...
type HandlerBuilder interface {
	...
	// SetListIpEntryTypes is invoked by Mixer to pass the template-specific Type information for instances that an adapter
	// may receive at runtime. The type information describes the shape of the instance.
	SetListIpEntryTypes(map[string]*Type /*Instance name -> Type*/)
}
...
// at configuration time via the method 'SetListIpEntryTypes'.
// These Type associated with an instance describes the shape of the instance
type Handler interface {
	adapter.Handler

	// HandleListIpEntry is called by Mixer at request time to deliver instances to
	// to an adapter.
	HandleListIpEntry(context.Context, *Instance) (adapter.CheckResult, error)
}
